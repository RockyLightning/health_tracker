...
class WorkoutsControllerTest < ActionController::TestCase
  ...
  test "should create workout" do
    assert_difference('Workout.count') do
      post :create, workout: { date: @workout.date, exercise_id: @workout.exercise_id, cals_burned: @workout.cals_burned }
    end
  ...
  test "should update workout" do
    patch :update, id: @workout, workout: { date: @workout.date, exercise_id: @workout.exercise_id, cals_burned: @workout.cals_burned }
    assert_redirected_to workout_path(assigns(:workout))
  end
